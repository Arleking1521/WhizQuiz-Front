    ...
    return (
        <footer>
            <div className="foot">
                ...
                <div>
                    <a href="https://instagram.com/whizquiz.almaty?igshid=MzRlODBiNWFlZA==" className="soc_link"><img src={inst_f} alt="" /></a>
                    <a href="https://vk.com/whiz.quiz" className="soc_link"><img src={vk_f} alt="" /></a>
                    <a href="https://api.whatsapp.com/send/?phone=77079980268" className="soc_link"><img src={wpp_f} alt="" /></a>
                </div>
            </div>
        </footer>
    );
